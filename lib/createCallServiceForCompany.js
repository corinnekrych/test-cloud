                ...
                var options = {
                  ...
                  if(err) {
                    ...
                    if (callITSupportData.count >= 1) {
                          ...
                          res.json({errorResponse:{errorCode: constants.CREATE_CALL_SER_AVAL_ERR, errorMessage: "Call IT Support is already available for this language and company."}});
                    } else {
                      var createOption = {
                          "act": "create",
                          "type": constants.CALL_IT_SUPPORT_TABLE,
                    ...
                    $fh.db(createOption, function (err, data) {
                      if (err) {
                        console.error("Error " + err);
                              ...
                              res.json({successResponse:{successCode: constants.CREATE_CALL_SER_SUC, successMessage: "Call IT Support created successfully."}});
                      }
                  });
                }
              }
